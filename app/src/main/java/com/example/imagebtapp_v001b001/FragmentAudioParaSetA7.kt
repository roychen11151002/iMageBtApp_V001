...
import kotlinx.android.synthetic.main.fragment_audio_para_set_a7.*
import kotlinx.android.synthetic.main.fragment_con_state.*
import java.lang.Integer.parseInt

class FragmentAudioParaSetA7 : Fragment() {
    val paraData = arrayOf(
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_audio_para_set_a7, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        for(i in paraData.size until rdGpParaAudioPara.size) {
            when (i) {
                ...
                1 -> rdAudioPara1A7.visibility = GONE
                2 -> rdAudioPara2A7.visibility = GONE
                3 -> rdAudioPara3A7.visibility = GONE
                4 -> rdAudioPara4A7.visibility = GONE
                5 -> rdAudioPara5A7.visibility = GONE
                6 -> rdAudioPara6A7.visibility = GONE
                7 -> rdAudioPara7A7.visibility = GONE
                8 -> rdAudioPara8A7.visibility = GONE
                9 -> rdAudioPara9A7.visibility = GONE
                10 -> rdAudioPara10A7.visibility = GONE
                11 -> rdAudioPara11A7.visibility = GONE
                12 -> rdAudioPara12A7.visibility = GONE
                13 -> rdAudioPara13A7.visibility = GONE
                14 -> rdAudioPara14A7.visibility = GONE
                15 -> rdAudioPara15A7.visibility = GONE
            }
        }
        btnAudioParaWriteA7.setOnClickListener {
            // rdGpParaAudioPara.check(rdGpParaAudioPara.checkedRadioButtonId)
            for(dev in 0 .. BtDevUnit.deviceNo) {
                if ((activity as DevUnitMsg).getBtDevUnitList()[dev].nameLocalHfp.substring(0, 11).compareTo("iMage A7_BT") == 0) {
                    for (i in 0 .. 1) {
                        val sendMsg = BtDevMsg(0, 0)
                        var strList =
                            paraData[when (rdGpParaAudioPara.checkedRadioButtonId) {
                                R.id.rdAudioPara0A7 -> 0
                                R.id.rdAudioPara1A7 -> 1
                                R.id.rdAudioPara2A7 -> 2
                                R.id.rdAudioPara3A7 -> 3
                                R.id.rdAudioPara4A7 -> 4
                                R.id.rdAudioPara5A7 -> 5
                                R.id.rdAudioPara6A7 -> 6
                                R.id.rdAudioPara7A7 -> 7
                                R.id.rdAudioPara8A7 -> 8
                                R.id.rdAudioPara9A7 -> 9
                                R.id.rdAudioPara10A7 -> 10
                                R.id.rdAudioPara11A7 -> 11
                                R.id.rdAudioPara12A7 -> 12
                                R.id.rdAudioPara13A7 -> 13
                                R.id.rdAudioPara14A7 -> 14
                                R.id.rdAudioPara15A7 -> 15
                                else -> 0
                            }][i].split(' ')
                        ...
                        when (rdGpModeAudioParaA7.checkedRadioButtonId) {
                            R.id.rdModeBtAudioParaA7 -> {
    ...
    fun updateData() {
        btnAudioParaWriteA7.visibility =
